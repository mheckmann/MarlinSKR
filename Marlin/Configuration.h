...
#define STRING_CONFIG_H_AUTHOR "(Bucket, Ender-5 SKR)" // Who made the changes.
...
#define MACHINE_UUID "f8dee815-e29b-44fd-af12-9791ec914254"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 43, 6, -1.74 }
